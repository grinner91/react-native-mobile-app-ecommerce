...
import { CustomerProductsList } from "./components/CustomerProductsList.js";
...
import { retrieveState } from "./common/app.localstore";
  ...
  return (
    ...
    >
      <NavigationContainer>
        <Tab.Navigator>
          <>
            <Tab.Group navigationKey={state.isLoggedin ? "customer" : "guest"}>
              <Tab.Screen
                name="products"
